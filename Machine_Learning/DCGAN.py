# Script from Murilo Andre "standing on the shoulders of giants"
...
HEIGHT, WIDTH, CHANNEL = 64, 64, 3 # a RGB image [64,64,3]. You could work with another images just changing this integers
BATCH_SIZE = 9
EPOCH = 5000
data = 'newAnime'
new_path = './' + data
...
def train():
	...
	for i in range(0,EPOCH):
		...
		if i % 30 == 0: # Each 30 epochs save a model
